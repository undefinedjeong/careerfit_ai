...
if __name__ == "__main__":
    ...
    processed = check_missing(df_jobs)
    processed = handle_missing(processed)
    processed = remove_duplicates(processed)
    processed = standardize_skills(processed)

    save_to_sqlite(processed, DB_PATH)
    query_sqlite(DB_PATH)

    rag_docs = convert_to_rag_documents(processed)
